...
| [matrix-clock](./apps/matrix-clock/README.md) | Clock based on RP2040 (Raspberry Pi Pico) using 16×16 NeoPixel (WS2812) LED matrix and RTC module DS3231. Time is displayed in HH:MM format, seconds are shown on the perimeter of the matrix. |
